...
public class FlightsOnGround extends StreamsInterface {
    final static Logger logger = LogManager.getLogger(FlightsOnGround.class);

    @Override
    public Properties updateProperties() {
        Properties props = new Properties();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "current-flights-on-ground-counter-app");
    ...
    public Topology createTopology() {
        ...
        KTable<String, String> uniquesFlightCountsByKey = flights
                .filter((key, value) ->  {return value.get("onGround").toString().matches("true");})
                .selectKey((key, value) -> {
                ...
                .mapValues(new ValueMapper<Long, String>() {
                    ...
                    public String apply(final Long count) {
                        ...
                        dashboard.setDashboardTitle("Flights On Ground");
